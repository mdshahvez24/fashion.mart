...
const rows = [
    createData('Name', 'Mohd Shahvez'),
    createData('User Name','mdshahvez24'),
    createData('Email', 'mdshahvez24@gmail.com'),
    createData('Phone', '8272028781'),
    createData('Address Line 1', "House Number 119K"),
    createData('Address Line 2', "Street Number 5"),
    createData('Address Line 3', "Village Ratheri"),
    createData('PIN', "251001"),
    createData('City', "Muzaffarnagar"),
                            ...
                            <tbody>
                                ...
                                </tr>
                                {
                                    shoppingCart.length > 0 ?
                                        <tr>
                                            <th colSpan={2}><button  className='btn btn-primary background text-light w-100 btn-sm' onClick={placeOrder}>Place Order</button></th>
                                        </tr>
                                        : ""
                                }
                            </tbody>
